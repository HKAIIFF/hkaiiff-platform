  ...
  return (
    <div className="w-full px-3 sm:px-4 pt-8 pb-2 border-t border-white/[0.06]">
      ...
      <footer className="w-full flex flex-col items-center justify-center py-8 px-2 gap-1.5">
        <p className="text-[10px] text-void-hint tracking-widest uppercase text-center">
          © 2026 All Rights Reserved.
        </p>
        <p className="text-[11px] text-void-hint font-medium tracking-widest mt-1 text-center">
          香港人工智能國際電影節協會
        </p>
        <p className="text-[9px] text-void-subtle tracking-widest uppercase text-center">
