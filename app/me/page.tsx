...
function MePageContent() {
  ...
  return (
    <div className="flex-1 h-full w-full bg-void flex flex-col relative overflow-y-auto md:overflow-hidden pt-28 md:pt-0 pwa-me-main-scroll-pt pb-bottom-nav-safe md:pb-0 min-h-screen md:min-h-0">
      ...
      <div className="hidden md:flex flex-shrink-0 z-10 bg-[#030303]/95 backdrop-blur border-b border-[#1a1a1a] px-6 py-4 items-center justify-between">
        ...
        <button
          ...
          className="hidden md:flex w-8 h-8 rounded-full bg-[#111] border border-[#333] items-center justify-center
                     text-void-fg hover:text-white hover:border-signal transition-all cursor-pointer"
          title="Sign Out"
        >
      ...
      <div className="relative flex flex-col md:flex-row md:items-start gap-5 mb-6 bg-[#111] p-5 rounded-xl border border-[#333] shadow-[0_0_20px_rgba(0,0,0,0.5)]">
        ...
        <div className="absolute top-4 right-4 flex items-center space-x-2 z-10">
          ...
          <button
            ...
            className="w-8 h-8 rounded-full bg-[#111] border border-[#333] flex items-center justify-center text-void-fg hover:text-signal hover:border-signal transition-colors"
            title="Edit Profile"
          >
          ...
          <button
            onClick={() => logout()}
            className="w-8 h-8 rounded-full bg-[#111] border border-[#333] flex items-center justify-center text-void-fg hover:text-red-500 hover:border-red-500 transition-colors"
            title="Logout"
          >
      ...
      <div className="mb-8">
        {mySubmissions.length === 0 ? (
          <div className="text-center text-xs text-void-muted font-mono py-8 border border-dashed border-[#333] rounded-xl">
            <i className="fas fa-film text-2xl mb-3 block text-void-subtle" />
              ...
              return (
                ...
                >
                  ...
                  <div className="aspect-[2/3] relative overflow-hidden bg-black">
                    {film?.poster_url ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-[#0a0a0a]">
                        <i className="fas fa-film text-void-subtle text-2xl" />
                      </div>
                    )}
                    {/* 狀態角標 */}
                  ...
                  <div className="p-2.5 space-y-1.5">
                    ...
                    {/* 創作者 */}
                    <div className="text-[10px] text-void-muted font-mono truncate">
                    ...
                    <div className="flex items-center gap-1 pt-0.5">
                      <span className="text-[9px] font-mono text-void-muted flex-1 truncate tracking-wider">
        ...
        {interactionHistory.length > 0 ? (
          interactionHistory.map((item) => (
            ...
            >
              ...
              <button className="text-void-muted hover:text-white">
          ...
          <div className="relative w-full max-w-sm">
            ...
            <button
              ...
              className="absolute -top-3 -right-3 z-20 w-9 h-9 bg-black border border-[#333] rounded-full
                         flex items-center justify-center text-void-fg hover:text-white hover:border-[#CCFF00]
              ...
              <div className="relative bg-[#050505] rounded-xl overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 p-8 pb-5">
                  ...
                  >
                    ...
                    <p className="text-void-fg text-sm mt-2">
                  ...
                  <div className="grid grid-cols-3 gap-2 relative z-10 mb-5">
                    <div className="bg-black/40 border border-[#D4AF37]/20 rounded-lg p-2 text-center">
                      <div className="text-[8px] font-mono text-void-muted tracking-widest mb-1">AI RATIO</div>
                      <div className="text-[#CCFF00] font-bold text-base">{selectedFilm?.ai_ratio ?? 0}%</div>
                    </div>
                    <div className="bg-black/40 border border-[#D4AF37]/20 rounded-lg p-2 text-center">
                      <div className="text-[8px] font-mono text-void-muted tracking-widest mb-1">TECH STACK</div>
                    ...
                    <div className="bg-black/40 border border-[#D4AF37]/20 rounded-lg p-2 text-center">
                      <div className="text-[8px] font-mono text-void-muted tracking-widest mb-1">DATE</div>
                ...
                <div className="relative w-full h-44 overflow-hidden bg-[#0a0a0a]">
                  {selectedFilm?.poster_url ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <i className="fas fa-film text-5xl text-void-subtle" />
                    </div>
                  )}
                ...
                <div className="p-5 space-y-4">
                  {selectedFilm?.status === 'rejected' ? (
                    ...
                    <div className="flex flex-col items-center gap-3 py-4 text-center">
                      ...
                      <p className="text-void-muted text-xs font-mono leading-relaxed">
                        Your submission is being reviewed by the HKAIIFF jury. You will be notified once a decision is made.
                      </p>
                    </div>
                  )}

                  <div className="text-[9px] font-mono text-void-muted text-center pt-1">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-[#1a1a1a] flex-shrink-0">
              ...
              <button
                ...
                className="w-9 h-9 bg-[#111] border border-[#2a2a2a] rounded-full flex items-center justify-center
                           text-void-fg hover:text-white hover:border-signal active:scale-90 transition-all"
              >
                <i className="fas fa-times text-sm" />
              </button>
            </div>
          ...
          <div className="relative w-full sm:max-w-lg bg-[#080808] border border-[#2a2a2a] sm:rounded-2xl rounded-t-2xl overflow-hidden shadow-[0_0_80px_rgba(204,255,0,0.12)] flex flex-col" style={{ maxHeight: 'min(92vh, calc(100dvh - env(safe-area-inset-bottom) - env(safe-area-inset-top)))' }}>
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-[#1a1a1a] flex-shrink-0">
              ...
              <button
                ...
                className="w-9 h-9 bg-[#111] border border-[#333] rounded-full flex items-center justify-center text-void-fg hover:text-white hover:border-signal active:scale-90 transition-all"
              >
                <i className="fas fa-times text-sm" />
              </button>
            </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className={`text-[9px] font-mono px-2 py-1 rounded tracking-widest transition-all border
                              ${isAvatarLocked
                                ? 'text-void-subtle border-gray-700/30 bg-gray-800/30 cursor-not-allowed opacity-50'
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full font-mono text-sm px-3 py-2.5 rounded-lg outline-none transition-all
                          ${isNameLocked
                            ? 'bg-gray-100 border border-yellow-900/30 text-void-muted cursor-not-allowed opacity-60 select-none'
                            : 'bg-[#0d0d0d] border border-[#2a2a2a] text-white focus:border-signal focus:shadow-[0_0_12px_rgba(204,255,0,0.15)] placeholder:text-void-subtle'
                          }`}
                      />
                    </div>
                  );
            ...
            >
              <button
                onClick={closeProfileModal}
                disabled={isSaving}
                className="flex-1 py-2.5 bg-[#111] text-void-fg font-heavy text-[11px] rounded-lg tracking-widest
              ...
              {(() => {
                ...
                if (isNameLocked) {
                  return (
                    <button
                      disabled
                      className="flex-[2] py-2.5 bg-gray-800/60 text-void-muted font-heavy text-[11px] rounded-lg tracking-widest
