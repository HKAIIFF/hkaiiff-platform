...
export default function AwardsPage() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white overflow-x-hidden">
      {/* ── BACK BUTTON ─────────────────────────────────────────── */}
      <div className="fixed top-4 left-4 sm:top-6 sm:left-6 z-50 awards-mobile-back-top">
        <BackButton />
      </div>
      {/* ── HERO ────────────────────────────────────────────────── */}
      <section
      ...
      >
        ...
        <motion.div
          ...
          className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 py-24 awards-mobile-hero-spacer flex flex-col md:flex-row md:items-center gap-12"
        >
          {/* Left — text */}
